...
${OBJECTDIR}/Algorithms/DynamicProgramming/01KnapsackProblem.o: Algorithms/DynamicProgramming/01KnapsackProblem.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/DynamicProgramming/01KnapsackProblem.o Algorithms/DynamicProgramming/01KnapsackProblem.c

${OBJECTDIR}/Algorithms/DynamicProgramming/FloydWarshallAlgorithm.o: Algorithms/DynamicProgramming/FloydWarshallAlgorithm.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/DynamicProgramming
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/DynamicProgramming/FloydWarshallAlgorithm.o Algorithms/DynamicProgramming/FloydWarshallAlgorithm.c
...
${OBJECTDIR}/Algorithms/DynamicProgramming/LongestCommonSubsequence.o: Algorithms/DynamicProgramming/LongestCommonSubsequence.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/DynamicProgramming
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/DynamicProgramming/LongestCommonSubsequence.o Algorithms/DynamicProgramming/LongestCommonSubsequence.c
...
${OBJECTDIR}/Algorithms/DynamicProgramming/MatrixChainMultiplication.o: Algorithms/DynamicProgramming/MatrixChainMultiplication.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/DynamicProgramming
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/DynamicProgramming/MatrixChainMultiplication.o Algorithms/DynamicProgramming/MatrixChainMultiplication.c

${OBJECTDIR}/Algorithms/DynamicProgramming/MultiStageGraph.o: Algorithms/DynamicProgramming/MultiStageGraph.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/DynamicProgramming
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/DynamicProgramming/MultiStageGraph.o Algorithms/DynamicProgramming/MultiStageGraph.c

${OBJECTDIR}/Algorithms/DynamicProgramming/SubsetSumProblem.o: Algorithms/DynamicProgramming/SubsetSumProblem.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/DynamicProgramming
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/DynamicProgramming/SubsetSumProblem.o Algorithms/DynamicProgramming/SubsetSumProblem.c
...
${OBJECTDIR}/Algorithms/GreedyAlgorithms/DijkstraAlgorithm.o: Algorithms/GreedyAlgorithms/DijkstraAlgorithm.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/GreedyAlgorithms/DijkstraAlgorithm.o Algorithms/GreedyAlgorithms/DijkstraAlgorithm.c

${OBJECTDIR}/Algorithms/GreedyAlgorithms/GreedyKnapsackProblem.o: Algorithms/GreedyAlgorithms/GreedyKnapsackProblem.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/GreedyAlgorithms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/GreedyAlgorithms/GreedyKnapsackProblem.o Algorithms/GreedyAlgorithms/GreedyKnapsackProblem.c

${OBJECTDIR}/Algorithms/GreedyAlgorithms/HuffmanCodes.o: Algorithms/GreedyAlgorithms/HuffmanCodes.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/GreedyAlgorithms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/GreedyAlgorithms/HuffmanCodes.o Algorithms/GreedyAlgorithms/HuffmanCodes.c
...
${OBJECTDIR}/Algorithms/GreedyAlgorithms/JobSequencingWithDeadlines.o: Algorithms/GreedyAlgorithms/JobSequencingWithDeadlines.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/GreedyAlgorithms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/GreedyAlgorithms/JobSequencingWithDeadlines.o Algorithms/GreedyAlgorithms/JobSequencingWithDeadlines.c

${OBJECTDIR}/Algorithms/GreedyAlgorithms/PrimsAlgorithmWithHeap.o: Algorithms/GreedyAlgorithms/PrimsAlgorithmWithHeap.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/GreedyAlgorithms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/GreedyAlgorithms/PrimsAlgorithmWithHeap.o Algorithms/GreedyAlgorithms/PrimsAlgorithmWithHeap.c
...
${OBJECTDIR}/Algorithms/SortingTechniques/BubbleSort.o: Algorithms/SortingTechniques/BubbleSort.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/BubbleSort.o Algorithms/SortingTechniques/BubbleSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/BucketSort.o: Algorithms/SortingTechniques/BucketSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/BucketSort.o Algorithms/SortingTechniques/BucketSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/CountingSort.o: Algorithms/SortingTechniques/CountingSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/CountingSort.o Algorithms/SortingTechniques/CountingSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/InsertionSort.o: Algorithms/SortingTechniques/InsertionSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/InsertionSort.o Algorithms/SortingTechniques/InsertionSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/MergeSort.o: Algorithms/SortingTechniques/MergeSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/MergeSort.o Algorithms/SortingTechniques/MergeSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/QuickSort.o: Algorithms/SortingTechniques/QuickSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/QuickSort.o Algorithms/SortingTechniques/QuickSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/RadixSort.o: Algorithms/SortingTechniques/RadixSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/RadixSort.o Algorithms/SortingTechniques/RadixSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/SelectionSort.o: Algorithms/SortingTechniques/SelectionSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/SelectionSort.o Algorithms/SortingTechniques/SelectionSort.c

${OBJECTDIR}/Algorithms/SortingTechniques/ShellSort.o: Algorithms/SortingTechniques/ShellSort.c
	${MKDIR} -p ${OBJECTDIR}/Algorithms/SortingTechniques
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithms/SortingTechniques/ShellSort.o Algorithms/SortingTechniques/ShellSort.c

${OBJECTDIR}/CPracticeQuestions/Armstrong.o: CPracticeQuestions/Armstrong.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/Armstrong.o CPracticeQuestions/Armstrong.c

${OBJECTDIR}/CPracticeQuestions/ArrayOfPointerMultidimensional.o: CPracticeQuestions/ArrayOfPointerMultidimensional.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/ArrayOfPointerMultidimensional.o CPracticeQuestions/ArrayOfPointerMultidimensional.c

${OBJECTDIR}/CPracticeQuestions/BasicStringsCharacters.o: CPracticeQuestions/BasicStringsCharacters.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/BasicStringsCharacters.o CPracticeQuestions/BasicStringsCharacters.c

${OBJECTDIR}/CPracticeQuestions/BasicStringsOperations.o: CPracticeQuestions/BasicStringsOperations.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/BasicStringsOperations.o CPracticeQuestions/BasicStringsOperations.c

${OBJECTDIR}/CPracticeQuestions/ConvertIntToChar.o: CPracticeQuestions/ConvertIntToChar.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/ConvertIntToChar.o CPracticeQuestions/ConvertIntToChar.c

${OBJECTDIR}/CPracticeQuestions/DeleteOccuranceOfC.o: CPracticeQuestions/DeleteOccuranceOfC.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/DeleteOccuranceOfC.o CPracticeQuestions/DeleteOccuranceOfC.c

${OBJECTDIR}/CPracticeQuestions/FahrenheitCelcius.o: CPracticeQuestions/FahrenheitCelcius.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/FahrenheitCelcius.o CPracticeQuestions/FahrenheitCelcius.c

${OBJECTDIR}/CPracticeQuestions/Fibonacci.o: CPracticeQuestions/Fibonacci.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/Fibonacci.o CPracticeQuestions/Fibonacci.c

${OBJECTDIR}/CPracticeQuestions/HalfPyramidStar.o: CPracticeQuestions/HalfPyramidStar.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/HalfPyramidStar.o CPracticeQuestions/HalfPyramidStar.c

${OBJECTDIR}/CPracticeQuestions/ImplementingStrCat.o: CPracticeQuestions/ImplementingStrCat.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/ImplementingStrCat.o CPracticeQuestions/ImplementingStrCat.c

${OBJECTDIR}/CPracticeQuestions/ImplementingStrCmp.o: CPracticeQuestions/ImplementingStrCmp.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/ImplementingStrCmp.o CPracticeQuestions/ImplementingStrCmp.c

${OBJECTDIR}/CPracticeQuestions/ImplementingStrCpy.o: CPracticeQuestions/ImplementingStrCpy.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/ImplementingStrCpy.o CPracticeQuestions/ImplementingStrCpy.c

${OBJECTDIR}/CPracticeQuestions/PalindromeNumber.o: CPracticeQuestions/PalindromeNumber.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/PalindromeNumber.o CPracticeQuestions/PalindromeNumber.c

${OBJECTDIR}/CPracticeQuestions/PointerArrayCopy.o: CPracticeQuestions/PointerArrayCopy.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/PointerArrayCopy.o CPracticeQuestions/PointerArrayCopy.c

${OBJECTDIR}/CPracticeQuestions/PointerArrays.o: CPracticeQuestions/PointerArrays.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/PointerArrays.o CPracticeQuestions/PointerArrays.c

${OBJECTDIR}/CPracticeQuestions/PointerSwapping1.o: CPracticeQuestions/PointerSwapping1.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/PointerSwapping1.o CPracticeQuestions/PointerSwapping1.c

${OBJECTDIR}/CPracticeQuestions/Prime.o: CPracticeQuestions/Prime.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/Prime.o CPracticeQuestions/Prime.c

${OBJECTDIR}/CPracticeQuestions/PyramidStarPattern.o: CPracticeQuestions/PyramidStarPattern.c
	${MKDIR} -p ${OBJECTDIR}/CPracticeQuestions
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CPracticeQuestions/PyramidStarPattern.o CPracticeQuestions/PyramidStarPattern.c
...
${OBJECTDIR}/DataStructures/GraphsPrograms/BfsDfs.o: DataStructures/GraphsPrograms/BfsDfs.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/GraphsPrograms/BfsDfs.o DataStructures/GraphsPrograms/BfsDfs.c
...
${OBJECTDIR}/DataStructures/GraphsPrograms/CheckingForAcyclicGraph.o: DataStructures/GraphsPrograms/CheckingForAcyclicGraph.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/GraphsPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/GraphsPrograms/CheckingForAcyclicGraph.o DataStructures/GraphsPrograms/CheckingForAcyclicGraph.c

${OBJECTDIR}/DataStructures/GraphsPrograms/TopologicalSort.o: DataStructures/GraphsPrograms/TopologicalSort.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/GraphsPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/GraphsPrograms/TopologicalSort.o DataStructures/GraphsPrograms/TopologicalSort.c
...
${OBJECTDIR}/DataStructures/HashingPrograms/ChainingInHashing.o: DataStructures/HashingPrograms/ChainingInHashing.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/HashingPrograms/ChainingInHashing.o DataStructures/HashingPrograms/ChainingInHashing.c
...
${OBJECTDIR}/DataStructures/HashingPrograms/OpenAddressingDoubleHashing.o: DataStructures/HashingPrograms/OpenAddressingDoubleHashing.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/HashingPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/HashingPrograms/OpenAddressingDoubleHashing.o DataStructures/HashingPrograms/OpenAddressingDoubleHashing.c
...
${OBJECTDIR}/DataStructures/HeapsPrograms/BuiltMaxHeap.o: DataStructures/HeapsPrograms/BuiltMaxHeap.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/HeapsPrograms/BuiltMaxHeap.o DataStructures/HeapsPrograms/BuiltMaxHeap.c

${OBJECTDIR}/DataStructures/HeapsPrograms/HeapSort.o: DataStructures/HeapsPrograms/HeapSort.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/HeapsPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/HeapsPrograms/HeapSort.o DataStructures/HeapsPrograms/HeapSort.c

${OBJECTDIR}/DataStructures/HeapsPrograms/OperationsOnHeap.o: DataStructures/HeapsPrograms/OperationsOnHeap.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/HeapsPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/HeapsPrograms/OperationsOnHeap.o DataStructures/HeapsPrograms/OperationsOnHeap.c
...
${OBJECTDIR}/DataStructures/LinkedListPrograms/ComprehensiveLinkedList.o: DataStructures/LinkedListPrograms/ComprehensiveLinkedList.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/LinkedListPrograms/ComprehensiveLinkedList.o DataStructures/LinkedListPrograms/ComprehensiveLinkedList.c

${OBJECTDIR}/DataStructures/LinkedListPrograms/DoublyLinkedList.o: DataStructures/LinkedListPrograms/DoublyLinkedList.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/LinkedListPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/LinkedListPrograms/DoublyLinkedList.o DataStructures/LinkedListPrograms/DoublyLinkedList.c
...
${OBJECTDIR}/DataStructures/RecursionPrograms/TowerOfHanoi.o: DataStructures/RecursionPrograms/TowerOfHanoi.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/RecursionPrograms/TowerOfHanoi.o DataStructures/RecursionPrograms/TowerOfHanoi.c
...
${OBJECTDIR}/DataStructures/StackQueuesPrograms/InfixToPostfixUsingStack.o: DataStructures/StackQueuesPrograms/InfixToPostfixUsingStack.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/StackQueuesPrograms/InfixToPostfixUsingStack.o DataStructures/StackQueuesPrograms/InfixToPostfixUsingStack.c
...
${OBJECTDIR}/DataStructures/StackQueuesPrograms/QueueUsingCircularArray.o: DataStructures/StackQueuesPrograms/QueueUsingCircularArray.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/StackQueuesPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/StackQueuesPrograms/QueueUsingCircularArray.o DataStructures/StackQueuesPrograms/QueueUsingCircularArray.c
...
${OBJECTDIR}/DataStructures/StackQueuesPrograms/QueueUsingLinkedList.o: DataStructures/StackQueuesPrograms/QueueUsingLinkedList.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/StackQueuesPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/StackQueuesPrograms/QueueUsingLinkedList.o DataStructures/StackQueuesPrograms/QueueUsingLinkedList.c

${OBJECTDIR}/DataStructures/StackQueuesPrograms/StackUsingArrays.o: DataStructures/StackQueuesPrograms/StackUsingArrays.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/StackQueuesPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/StackQueuesPrograms/StackUsingArrays.o DataStructures/StackQueuesPrograms/StackUsingArrays.c
...
${OBJECTDIR}/DataStructures/StackQueuesPrograms/StackUsingLinkedList.o: DataStructures/StackQueuesPrograms/StackUsingLinkedList.c
	${MKDIR} -p ${OBJECTDIR}/DataStructures/StackQueuesPrograms
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/StackQueuesPrograms/StackUsingLinkedList.o DataStructures/StackQueuesPrograms/StackUsingLinkedList.c
...
${OBJECTDIR}/DataStructures/TreesPrograms/ComprehensiveTreeProgram.o: DataStructures/TreesPrograms/ComprehensiveTreeProgram.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataStructures/TreesPrograms/ComprehensiveTreeProgram.o DataStructures/TreesPrograms/ComprehensiveTreeProgram.c
